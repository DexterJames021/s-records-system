...
@section('contents')
    <div class="mx-auto p-4">
        @if (session('success'))
            <div id="toast" class="fixed bottom-5 right-5 z-50 flex items-center px-3 py-2 rounded-lg bg-green-600 shadow-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                            <tr class="flex text-center">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">No data</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
